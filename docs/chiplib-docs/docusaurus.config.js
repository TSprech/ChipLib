...
const config = {
  title: 'ChipLib',
  tagline: 'Spend less time converting datasheets to code',
  ...
  organizationName: 'TSprech', // Usually your GitHub org/user name.
  projectName: 'ChipLib', // Usually your repo name.
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} TSprech/ChipLib Built with Docusaurus.`,
      },
      prism: {
